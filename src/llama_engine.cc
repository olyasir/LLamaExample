...
#include "cpp/grammar/grammar_state_matcher.h"
...
#include "cpp/serve/engine_actions/action.h"
#include "cpp/serve/engine_actions/action_commons.h"
#include "cpp/serve/engine_state.h"
#include "cpp/serve/event_trace_recorder.h"
#include "cpp/serve/logit_processor.h"
#include "cpp/serve/model.h"
#include "cpp/serve/request.h"
#include "cpp/serve/request_state.h"
#include "cpp/serve/sampler/sampler.h"
...
//EngineWithLoad::~EngineWithLoad() {}
/********************** Engine Impl **********************/

/*! \brief The implementation of Engine. */
class LlamaEngineImpl : public EngineWithLoad{
 ...
 public:
  ...
  static Result<LLamaEngineCreationOutput> Create(const std::string& engine_config_json_str,
    ...
    using TResult = Result<LLamaEngineCreationOutput>;
    std::unique_ptr<LlamaEngineImpl> n = std::make_unique<LlamaEngineImpl>();
    ...
    /*Note - removed context cache creation as it takes very long time - think if we need it */
...
Result<LLamaEngineCreationOutput> LlamaEngine::Create(const std::string& engine_config_json_str,
                                            Device device,
                                            FRequestStreamCallback request_stream_callback,
                                            Optional<EventTraceRecorder> trace_recorder) {
                                    
    return LlamaEngineImpl::Create(engine_config_json_str, device, request_stream_callback,
